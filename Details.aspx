<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Details.aspx.cs" Inherits="WebApplication2.Details" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        <div class="card">
            ...
            <div class="card-body">
                <div class="col-sm-3">
                    <img src="Uploaded/test.jpeg" height="220" /></div>

                <h6 class="card-card-subtitle">ISBN:
                    <asp:Label runat="server" ID="txtISBN">isban</asp:Label></h6>
                <h6 class="card-card-subtitle">Price:
                    <asp:Label runat="server" ID="txtPrice">100</asp:Label></h6>
